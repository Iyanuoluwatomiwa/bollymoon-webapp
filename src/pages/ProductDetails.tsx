...
function ProductDetails() {
  ...
  return (
    <>
      ...
      <div className="space-y-2 md:space-y-6 py-10 relative">
        <Container>
          <h1 className="text-lg md:text-xl font-bold text-foreground">
            Details
          </h1>
        </Container>
        <div className="grid lg:grid-cols-8 lg:gap-2">
          ...
          <div className="lg:col-span-5">
            <Container className="py-4 lg:pt-0 ">
            ...
            `}
                    ...
                    <div className="min-w-26 sm:min-w-30">
            ...
            {/* product details */}
            <>
              <Container className="sm:py-4 py-2  lg:py-2">
