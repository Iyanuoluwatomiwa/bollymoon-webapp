        ...
        {features.map(
          ({ icon, title, description, link, link_text }, index) => {
            ...
            return (
              <Card
                key={index}
                className="group shadow-md hover:shadow-xl transition-all duration-300 hover:scale-105 border-0 bg-background/20 flex flex-col gap-4 justify-between backdrop-blur-sm"
              >
