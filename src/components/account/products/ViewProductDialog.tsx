          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div>
                ...
                <p className="capitalize">{selectedProduct.brand}</p>
              </div>
              <div>
                <Label className="font-semibold text-sm text-muted-foreground">
                  Material
                </Label>
                <p className="capitalize">{selectedProduct.material}</p>
              </div>
              <div>
                <Label className="font-semibold text-sm text-muted-foreground">
                  Stock
                  ...
                  <ul className="space-y-2">
                    {variant.colors.map((c) => (
                      <li key={c.color} className="space-x-4 pl-2 flex">
                        <div className="flex gap-1 text-sm items-center capitalize">
                          <Label className="font-semibold text-muted-foreground">
                            Color:
                          </Label>
                          {c.color}
              ...
              <div className=" flex items-center flex-wrap justify-center sm:justify-start place-items-center sm:place-items-start gap-8">
                {selectedProduct.images.map((image, index) => {
                  return (
                    <figure
                      key={index}
                      className="w-[200px] rounded-md border-2 h-[200px] shadow-lg"
                    >
                      <img
                        src={image}
