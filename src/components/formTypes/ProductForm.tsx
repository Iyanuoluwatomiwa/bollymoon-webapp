...
import { productCategories, productSizesList } from '@/utils/data'
...
interface ProductFormProps {
  ...
  setSelectedCategory?: (value: keyof typeof productSizesList) => void
}
const ProductForm = ({
  product,
  onSubmit,
  ...
  console.log(loadingImagesStatus)

  const handleInputChange = (field: string, value: string) => {
    setFormData((prev) => ({ ...prev, [field]: value }))
  }
  const openSizeGuide = () => {
    if (setSelectedCategory && onOpenSizeGuide) {
