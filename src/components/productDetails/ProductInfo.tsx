...
function ProductInfo({ product, onOpenSizeGuide }: ProductInfoProp) {
  ...
  return (
    <section>
      ...
      <div>
        <Label className="block font-semibold mb-2">About This Product</Label>
        ...
        <>
          <div className="mb-6">
            <div className="flex items-center gap-6">
              <Label className="">Choose a Size</Label>
              <Button
                type="button"
                variant="outline"
                size="sm"
